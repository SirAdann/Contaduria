...
<body>
 ...
 <div class="page-header">
	<h3 class="blog-title text-center"><span class="label label-success">POLÍTICAS PARA LA COMPROBACIÓN FINANCIERA PROFOCIE-2014</span></h3>
      </div>
      <br>
      <p>
        <h5><div >Con el propósito de normar los criterios aplicables a la comprobación financiera de los
			   recursos del Programa de Fortalecimiento de la Calidad en Instituciones Educativas 
			   (PROFOCIE) 2014, la Secretaría de Educación Pública, ha emitido las políticas de 
			   comprobación a las cuales debemos dar cumplimiento de la siguiente manera. </div></h5>
   </p>
		<br>
